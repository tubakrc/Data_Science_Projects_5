...
def main():
    ...
    def home_page():
        ...
        for image_file in image_path_logo:
            image_path_logo = [os.path.join(current_dir, 'data', image_file) for image_file in image_path_logo]
            # st.image(image_paths1)
    ...
    def Insights():
        ...
        def main():
            ...
            for image_file in image_path1:
                image_path1 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path1]
                # st.image(image_paths1)
            ...
            for image_file in image_path2:
                image_path2 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path2]
                # st.image(image_paths1)
            ...
            for image_file in image_path3:
                image_path3 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path3]
                # st.image(image_paths1)
            ...
            for image_file in image_path4:
                image_path4 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path4]
            ...
            for image_file in image_path5:
                image_path5 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path5]
            ...
            for image_file in image_path6:
                image_path6 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path6]
            ...
            for image_file in image_path7:
                image_path7 = [os.path.join(current_dir, 'data', image_file) for image_file in image_path7]
                # st.image(image_paths1)
