...
def main():
    ...
    def home_page():
        ...
        def main():
            ...
            with dataset:
                ...
                st.markdown("""
                                                In this multiclass classification ML project, obesity levels are estimated based on individuals' daily living habits (e.g., eating patterns, physical activity levels, smoking, alcohol consumption) and demographic features (e.g., height, weight, age).
    ...
    def Blog():
        ...
        with col2:
            #st.header("Column 2")
            #st.write("This is the second column.")
            base64_images_col2 = [f"data:image/png;base64,{image_to_base64(path)}" for path in image_paths2]
    ...
    def Help():
        ...
        def send_email(name, email, question):
            ...
            msg['From'] = 'your-email@gmail.com'  # Gönderen e-posta adresi your-email@gmail.com
            msg['To'] = 'weightwisehelp24@gmail.com'  # Alıcı e-posta adresi

            # SMTP sunucu ayarları (örnek olarak Gmail kullanılmıştır)
            with smtplib.SMTP('smtp.gmail.com', 587) as server:
                server.starttls()
                server.login('weightwisehelp24@gmail.com', 'Caylak85!')  # E-posta ve şifre
                server.send_message(msg)

        # Streamlit uygulaması
        #st.title('Submit Your Question')
        st.markdown("""
    ...
    selected = option_menu(
        menu_title=None,
        options=["Home", "Insights", "Prediction", "YouTube", "Blog", "Help"],
