################################################
# End-to-End Obesity Type Machine Learning Pipeline II
################################################
...
def main():
    df = pd.read_csv("C:/Users/Tuba/PycharmProjects/pythonProject_Miuul/my_streamlit_frontend/data/ObesityDataSet_raw_and_data_sinthetic.csv")
